...
This is a flake for the Zen browser. It is based on [youwen5/zen-browser-flake](https://github.com/youwen5/zen-browser-flake),
which is originally forked from the unmaintained
...
inputs = {
  # ...
  zen-browser.url = "github:maximoffua/zen-browser.nix";
...
`nix profile install github:maximoffua/zen-browser.nix`
...
The Nix code is licensed under the Unlicense and is released unencumbered into the public
