      ...
      packages = forAllSystems (
        ...
        rec {
          zen-browser-twilight-unwrapped = pkgs.callPackage ./zen-browser-unwrapped.nix {
            hash=sources.twilight.${system};
            version = "twilight";
          };
          zen-browser-twilight = pkgs.callPackage ./zen-browser.nix { zen-browser-unwrapped = zen-browser-twilight-unwrapped; pname = "zen-browser-twilight"; };

          zen-browser-unwrapped = pkgs.callPackage ./zen-browser-unwrapped.nix {
            inherit (sources.stable) version;
            hash = sources.stable.${system};
          };
